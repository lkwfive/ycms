...
class EThumbnail extends CComponent
{
  ...
  private $_thumbnail;
    ...
    public function createWatermark($watermark_path, $proportion=0, $right_margin=0, $bottom_margin=0)
    {
            $this->_thumbnail=$this->_thumbnail->createWatermark($watermark_path, $proportion, $right_margin, $bottom_margin);
            return $this;
    }
}
?>
